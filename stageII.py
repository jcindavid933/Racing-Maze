...
def stageII():
    ...
    mblk1 = Blinky(160, 650)
    mblk2 = Blinky(400, 40)
    mblk3 = Blinky(650, 530)
    mblk4 = Blinky(930, 300)
    ...
    class SmallHorizontalWall2(pygame.sprite.Sprite):
        normal = pygame.image.load('/Users/david/Documents/small_horizontal_walls2.png')
        def __init__(self, position):
            super(SmallHorizontalWall2, self).__init__()
            self.rect = pygame.Rect(self.normal.get_rect())
            self.rect.center = position
            self.image = self.normal
    ...
    walls = [
        ...
        WallSprite((800, 600)),
        WallSprite((900, 600)),
        VerticalWall((337,342)),
        SmallHorizontalWall2((395, 103)),
        SmallVerticalWall((453,217)),
        SmallVerticalWall((453,370)),
        SmallVerticalWall((540,217)),
        SmallVerticalWall((540,370)),
        SmallHorizontalWall((675, 104)),
        SmallVerticalWall((800,217)),
        SmallVerticalWall((800,370)),
    ]
    ...
    trophy = [Trophy((381,150))] #Position of the Trophy
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if victory == None:
                ...
                time.sleep(0.4)
                stageIII.stageIII() #Move to the next level
                ...
                stageII() #Restart the current level
                t1 = t2
            elif event.key == K_ESCAPE:
                sys.exit(0)
